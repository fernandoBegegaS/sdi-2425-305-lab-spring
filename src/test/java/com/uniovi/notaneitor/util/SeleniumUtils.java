...
public class SeleniumUtils {
	...
	{
		Boolean resultado =
				(new WebDriverWait(driver, Duration.ofSeconds(timeout).toMillis())).until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[contains(text(),'" + text + "')]")));
	...
	{
		WebElement result =
				(new WebDriverWait(driver, Duration.ofSeconds(timeout).toMillis())).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath)));
